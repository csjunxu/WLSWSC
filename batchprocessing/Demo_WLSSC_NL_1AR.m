...
for lambdasc = [0.05 0.06]
    ...
    for lambdals = [0.9 1.1 0.8 1.2]
        ...
        mCCPSNR = mean(CCPSNR);
        mCCSSIM = mean(CCSSIM);
        save(['WLSSC_NL_1AR_lsc' num2str(lambdasc) '_lls' num2str(lambdals) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
    end
end