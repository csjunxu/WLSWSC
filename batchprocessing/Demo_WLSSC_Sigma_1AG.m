...
for delta = 0.08
    ...
    for lambdasc = 1:0.5:5
        ...
        name = sprintf(['WLSSC_Sigma_1AG_m' num2str(par.model) '_nSig' num2str(nSig) '_delta' num2str(delta) '_lsc' num2str(lambdasc) '_WWIter' num2str(par.WWIter) '.mat']);
