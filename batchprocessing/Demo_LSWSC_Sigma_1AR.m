...
par.model = 2;
par.WWIter = 100;
for lambdasc = [0.008 0.005 0.003 0.001]
    ...
    mCCPSNR = mean(CCPSNR);
    mCCSSIM = mean(CCSSIM);
    save(['LSWSC_Sigma_1AR_lsc' num2str(lambdasc) '_WWIter' num2str(par.WWIter) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
end