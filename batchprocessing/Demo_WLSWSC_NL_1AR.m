...
for lambdasc = [0.01 0.03 0.05 0.1]
    ...
    for lambdals1 = [0.01 -0.01 0.05 -0.05]
        ...
        mCCPSNR = mean(CCPSNR);
        mCCSSIM = mean(CCSSIM);
        save(['WLSWSC_NL_1AR_lsc' num2str(lambdasc) '_lls1' num2str(lambdals1) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
    end
end
