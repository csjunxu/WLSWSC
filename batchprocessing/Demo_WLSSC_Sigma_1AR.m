...
for delta = 0
    ...
    for nSig = 0.1:0.05:0.25
        ...
        for lambdasc = 0.3:0.2:0.9
            ...
            mCCPSNR = mean(CCPSNR);
            mCCSSIM = mean(CCSSIM);
            save(['WLSSC_Sigma_1AR_nSig' num2str(nSig) '_delta' num2str(delta) '_' num2str(lambdasc) '_WWIter' num2str(par.WWIter) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
        end
    end
end