...
for delta = [0.08 0.1]
    ...
    for lambdasc = 0.2:0.1:1
        ...
        for lambdals = [0.85 0.8]
            ...
            name = sprintf(['WLSWSC_Sigma_WAG_m' num2str(par.model) '_' Sdir{end-1} '_nSig' num2str(nSig) '_delta' num2str(delta) '_lsc' num2str(lambdasc) '_WIter' num2str(par.WWIter) '.mat']);
