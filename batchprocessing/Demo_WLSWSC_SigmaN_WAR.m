    ...
    for lambdals = 1:-0.1:0.8
        ...
        for lambdasc = 2.5:0.1:3
            ...
            for i = 1 : im_num
                ...
                par.imIndex = i;
                t1=clock;
                [IMout, par]  =  WLSWSC_SigmaN_WAR(par);
                t2=clock;
                etime(t2,t1)
            ...
            mCCPSNR = mean(CCPSNR);
            mCCSSIM = mean(CCSSIM);
            save(['WLSWSC_SigmaN_WAR_nSig0' num2str(nSig0) '_lls' num2str(lambdals) '_lsc' num2str(lambdasc) '_WWIter' num2str(par.WWIter) '.mat'],'alltime','mtime','PSNR','mPSNR','SSIM','mSSIM','CCPSNR','mCCPSNR','CCSSIM','mCCSSIM');
        end
    end
end